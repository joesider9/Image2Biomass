...
def GPU_thread(static_data, n_gpus, n_jobs, cluster=None, method=None, refit=False, gpu_id=None):
...
def train_on_gpus(static_data, cluster=None, global_method=None, cluster_method=None,
                  refit=False, gpu_id=None, n_jobs=None):
    ...
    for method in global_methods:
        ...
        GPU_thread(static_data, n_gpus, static_data[method]['n_jobs'] if n_jobs is None else n_jobs,
